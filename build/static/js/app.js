...
module.exports = __webpack_require__.p + "static/media/happy-timer-logo.svg";

/***/ }),
/* 23 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "static/media/Icon-settings.svg";
...
var react_switch = __webpack_require__(10);
var react_switch_default = /*#__PURE__*/__webpack_require__.n(react_switch);

// EXTERNAL MODULE: ./src/happy-timer-logo.svg
var happy_timer_logo = __webpack_require__(22);
var happy_timer_logo_default = /*#__PURE__*/__webpack_require__.n(happy_timer_logo);

// EXTERNAL MODULE: ./src/Icon-settings.svg
var Icon_settings = __webpack_require__(23);
var Icon_settings_default = /*#__PURE__*/__webpack_require__.n(Icon_settings);

// EXTERNAL MODULE: ./src/App.css
var src_App = __webpack_require__(28);

// CONCATENATED MODULE: ./src/App.js
/*global chrome*/var App_App=/*#__PURE__*/function(_Component){Object(inherits["a" /* default */])(App,_Component);function App(){var _this;Object(classCallCheck["a" /* default */])(this,App);_this=Object(possibleConstructorReturn["a" /* default */])(this,Object(getPrototypeOf["a" /* default */])(App).call(this));_this.state={sidebarchecked:false,soundChecked:false,notificationChecked:false,timerRuned:false,startTime:"",timeLength:0,time:0};_this.handleChangeSidebar=_this.handleChangeSidebar.bind(Object(assertThisInitialized["a" /* default */])(_this));_this.handleChangeSound=_this.handleChangeSound.bind(Object(assertThisInitialized["a" /* default */])(_this));_this.handleChangeNotification=_this.handleChangeNotification.bind(Object(assertThisInitialized["a" /* default */])(_this));return _this;}Object(createClass["a" /* default */])(App,[{key:"componentDidMount",value:function componentDidMount(){var _this2=this;chrome.storage.sync.get(['sidebarchecked','soundChecked','notificationChecked',"startTime","timerRuned","timeLength"],function(result){console.log(result.startTime,result.timerRuned,result.timeLength);_this2.setState({sidebarchecked:result.sidebarchecked,soundChecked:result.soundChecked,notificationChecked:result.notificationChecked,timerRuned:result.timerRuned,startTime:result.startTime,timeLength:result.timeLength*60,time:Date.now()});if((Date.now()-result.startTime)/60000<result.timeLength&&result.timerRuned){_this2.startTimer();}});}},{key:"startTimer",value:function startTimer(){var _this3=this;var tim=setInterval(function(){if(_this3.state.timeLength-(_this3.state.time-_this3.state.startTime)/1000<=0){clearInterval(tim);return;}_this3.setState({time:Date.now()});},1000);}},{key:"handleChangeSidebar",value:function handleChangeSidebar(sidebarchecked){var _this4=this;chrome.storage.sync.set({sidebarchecked:sidebarchecked},function(){chrome.runtime.sendMessage({greeting:"hello"},function(response){console.log(response.farewell);});chrome.runtime.sendMessage({event:"toggleSidebar"},function(response){console.log(response.slider);_this4.setState({sidebarchecked:sidebarchecked});});});}},{key:"handleChangeSound",value:function handleChangeSound(soundChecked){var _this5=this;chrome.storage.sync.set({soundChecked:soundChecked},function(){_this5.setState({soundChecked:soundChecked});});}},{key:"handleChangeNotification",value:function handleChangeNotification(notificationChecked){var _this6=this;chrome.storage.sync.set({notificationChecked:notificationChecked},function(){_this6.setState({notificationChecked:notificationChecked});});}},{key:"getSeconds",value:function getSeconds(){var second=60-Math.floor((this.state.time-this.state.startTime)%(1000*60)/1000);return second<10?"0"+second:second;}},{key:"getMinute",value:function getMinute(){var minute=Math.trunc((this.state.timeLength-(this.state.time-this.state.startTime)/1000)/60);return minute<10?"0"+minute:minute;}},{key:"render",value:function render(){return react_default.a.createElement("div",{className:"popup_container"},react_default.a.createElement("div",{className:"extensionLogo",style:{backgroundImage:"url(".concat(chrome.runtime.getURL(happy_timer_logo_default.a),")")}}),react_default.a.createElement("div",{className:"extensionVersion"},"Version 1.0"),react_default.a.createElement("div",{className:"extContent"},react_default.a.createElement("div",{className:"row"},react_default.a.createElement("p",{className:"text"},"Timer Sidebar Icon"),react_default.a.createElement(react_switch_default.a,{className:"switch",height:17.5,width:39.22,offColor:"#FDF1C3",onColor:"#FAD961",checkedIcon:false,uncheckedIcon:false,onChange:this.handleChangeSidebar,checked:this.state.sidebarchecked})),react_default.a.createElement("div",{className:"row"},react_default.a.createElement("p",{className:"text"},"Sound when the timer hits zero"),react_default.a.createElement(react_switch_default.a,{className:"switch",height:17.5,width:39.22,offColor:"#FDF1C3",onColor:"#FAD961",checkedIcon:false,uncheckedIcon:false,onChange:this.handleChangeSound,checked:this.state.soundChecked})),react_default.a.createElement("div",{className:"row"},react_default.a.createElement("p",{className:"text"},"Deskt notification when timer hits zero"),react_default.a.createElement(react_switch_default.a,{className:"switch",height:17.5,width:39.22,offColor:"#FDF1C3",onColor:"#FAD961",checkedIcon:false,uncheckedIcon:false,onChange:this.handleChangeNotification,checked:this.state.notificationChecked}))),console.log(this.state.timeLength,this.state.time,this.state.startTime),react_default.a.createElement("div",{className:"middleContent"},this.state.timerRuned&&this.state.timeLength-(this.state.time-this.state.startTime)/1000>0?null:react_default.a.createElement("p",{className:"text"},"\u201EThe only permanent form of happiness lies in the consciousness of productivity.\u201C"),this.state.timerRuned&&this.state.timeLength-(this.state.time-this.state.startTime)/1000>0?react_default.a.createElement("p",{className:"timeRuned"},"Timer:\xA0",this.getMinute(),":",this.getSeconds()):null,react_default.a.createElement("p",{"class":"author"},"- Carl Zuckmayer")),react_default.a.createElement("div",{className:"feedbackContainer"},react_default.a.createElement("a",{className:"feedbackLink",href:"https://airtable.com/shrpzD6EmFLs6R2sK",onClick:function onClick(){chrome.tabs.create({'url':'https://airtable.com/shrpzD6EmFLs6R2sK'});}},"Send Feedback"),react_default.a.createElement("div",{className:"settings",style:{backgroundImage:"url(".concat(chrome.runtime.getURL(Icon_settings_default.a),")")},onClick:function onClick(){chrome.tabs.create({'url':'chrome://extensions/?options='+chrome.runtime.id});}})));}}]);return App;}(react["Component"]);
