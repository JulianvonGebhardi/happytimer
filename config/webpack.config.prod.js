...
/**
 * Create webpack configuration for a specific browser
 * @param {Object} options - Configuration options
 * @param {string} options.target - Target browser ('chrome' or 'firefox')
 * @param {string} options.outputDir - Output directory
 * @returns {Object} Webpack configuration
 */
function createConfig({ target = 'chrome', outputDir = paths.appBuild } = {}) {
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        // Add polyfill alias for browser APIs
    ...
    plugins: [
      ...
      // Add DefinePlugin for browser detection
      new webpack.DefinePlugin({
        'process.env.BROWSER': JSON.stringify(target),
        'process.env.IS_CHROME': JSON.stringify(isChrome),
